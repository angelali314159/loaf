...
export default function ExercisePreview() {
  ...
  const imageUrl = exerciseFromLibrary.image_url || null;
              ...
              >
                <Svg width="100%" height="100%">
                  <Defs>
                    ...
                    >
                      <Stop offset="0%" stopColor="#FCDE8C" stopOpacity={0.55} />
            ...
            <View style={{ paddingHorizontal: 24 }}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  console.log("Exercise ID:", exerciseFromLibrary.exercise_lib_id);
                }}
                style={{
                  marginTop: 22,
