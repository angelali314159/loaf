  ...
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="flex-1 items-center justify-start pt-16 px-6">
        ...
        <H1 baseSize={28} className="text-center mb-2">Navigation Hub</H1>
        <H2 baseSize={14} className="text-center mb-8 text-gray-600">
          Navigate to any page in the app. until this page has something better
        </H2>

        {/* Main App Pages */}
        <View className="w-full mb-6">
          <H2 baseSize={16} className="mb-4 font-semibold">Main Pages</H2>
        ...
        <View className="w-full mb-6">
          <H2 baseSize={16} className="mb-4 font-semibold">Authentication</H2>
        ...
        {/* Exercise & Workout Pages */}
        <View className="w-full mb-6">
          <H2 baseSize={16} className="mb-4 font-semibold">Exercise & Workouts</H2>
